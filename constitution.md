...
Use `FinalResponse` when the tool has already communicated with the user via `self.send_broadcast()`. This prevents the agent from sending a redundant follow-up message.
